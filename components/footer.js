                    ...
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-white hover:text-accent-1" href="#">First Link</a>
                                </li>
                                <li>
                                    <a className="text-white hover:text-accent-1" href="#">Second Link</a>
                                </li>
                                <li>
                                    <a className="text-white hover:text-accent-1" href="#">Third Link</a>
                                </li>
                                <li>
                                    <a className="text-white hover:text-accent-1" href="#">Fourth Link</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <div className="bg-gray-700">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-white text-sm text-center sm:text-left">© 2021 Magpie.IM —
                            <a href="https://magpie.im" rel="noopener noreferrer"
