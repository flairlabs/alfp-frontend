...
export async function getFundManagerBoardMembers() {
    ...
    query FundManagerBoardMemberQuery {
      fundManagerBoardMembers(first: 10000) {
        nodes {
...
export async function getFileLibraryItems() {
    ...
    query FileLibraryItems {
        fileLibraryItemTypes(first: 10000) {
            nodes {
              name
              slug
              children {
...
export async function getFileLibraryItemByTypeSlug(slug) {
    let query = `
        query FileLibraryItems {
            fileLibraryItemTypes(first: 10000, where: {slug: "${slug}"}) {
                nodes {
                  name
                  slug
                  
                  fileLibraryItems(first: 10000) {
                    nodes {
                      id
                      title
                      fileLibraryItem {
