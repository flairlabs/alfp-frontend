        ...
        frontpage: [
            {
                ...
                url: "/page/investment-basics",
                cms_id: "cG9zdDo3",
                excerpt: `A Mutual Fund is an open end investment company registered with the Securities and Exchange Commission (SEC) in which the investible cash of numerous investors are pooled in a specific fund (\"fund\") with the aim of achieving a specific investment objective. The Fund is NOT a DEPOSIT product and is not an obligation of, or guaranteed, or insured by the Fund Manager, and is not insured by the Philippine Deposit Insurance Corporation (PDIC). Due to the nature of the investments, yield and potential yields cannot be guaranteed. Historical performance, when presented, is purely for reference purposes and is not a guarantee of future results.`
            }
        ]
    },
    staging: {
