...
export default function Fund({fund = null, tickerData, fundValues}) {
    ...
    return (
        <>
            <PageLayout title={pageContext.title} preview={false} tickerData={tickerData} theme="350c">
                <PageTitle title={pageContext.heading} allCaps={true} extraClasses="text-accent-2"/>
                <div className="flex flex-wrap mx-auto overflow-hidden">
                    <div className="my-1 px-1 w-full overflow-hidden sm:w-full md:w-full lg:w-2/3">
                        <div className="page-text mb-3 page-text pr-3 mr-3 p350c"
                    ...
                    <div className="my-1 px-1 w-full overflow-hidden sm:w-full md:w-full lg:w-1/3">
                        ...
                        <InfoTable data={infoTable} theme="350c" />
                    </div>
                ...
                <div className="flex flex-wrap -mx-2 overflow-hidden">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="w-1/4 mr-3 px-3">
                                <img src="/images/icons/finances.png"/>
                            </div>
                            <div>
                    ...
                    <div
                        ...
                        <div
                            className="bg-white flex items-center hover:bg-gray-200 p-3">
                            <div className="w-1/4 mr-3 px-3">
                                <img src="/images/icons/presentation.png"/>
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-gray-700 mb-2">
                    ...
                    <div
                        ...
                        <div
                            className="bg-white flex items-center hover:bg-gray-200 p-3">
                            <div className="w-1/4 mr-3 px-3">
                                <img src="/images/icons/loudspeaker.png"/>
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-gray-700 mb-2">
                    ...
                    <div
                        ...
                        <div
                            className="bg-white flex items-center hover:bg-gray-200 p-3">
                            <div className="w-1/4 mr-3 px-3">
                                <img src="/images/icons/safebox.png"/>
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-gray-700 mb-2">
                ...
                <ResponsiveContainer width={'99%'} height={300}>
                    ...
                    >
                        ...
                        <Tooltip/>
                        <Legend/>
                        <Line type="monotone" dataKey="val" stroke="#2c5236"/>
                    </LineChart>
                </ResponsiveContainer>
